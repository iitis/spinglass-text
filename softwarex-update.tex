...
%% Authorship settled: the list below reproduces the original publication, which is
%% correct for this update. Project.toml additionally credits Dariusz Kurzyk as a
%% package co-author; he is not a co-author of the improvements described here, so
%% the discrepancy is intentional and needs no reconciliation.
\author[iitis]{Tomasz \'Smierzchalski}
\author[uj,ujdoc]{Anna Maria Dziubyna}
\author[iitis]{Konrad Ja\l{}owiecki}
\author[iitis]{Zakaria Mzaouali}
\author[iitis]{\L{}ukasz Pawela\corref{cor}}
\ead{lpawela@iitis.pl}
\author[iitis]{Bart\l{}omiej Gardas}
\author[uj]{Marek M. Rams}
...
\address[uj]{Jagiellonian University, Institute of Theoretical Physics,
\L{}ojasiewicza 11, 30-348 Krak\'ow, Poland}
\address[ujdoc]{Jagiellonian University, Doctoral School of Exact and Natural
Sciences, \L{}ojasiewicza 11, 30-348 Krak\'ow, Poland}
...
solve; addressing that yields ${\approx}1.15\times$ on each device. We also
...
of energies and how many transformations reached the best one. Eight independent
...
in that reproducibility that predates this update.
