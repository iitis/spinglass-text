...
in that reproducibility that predates this update. The raw per-run data and figure scripts behind every figure and table, together with the drivers for the crossover, concurrency, diversity, and energy-vs-runtime results, are provided with the manuscript sources in the \texttt{benchmarks/} directory; only the allocation before/after profile still requires a manual pre-change build, documented there.
