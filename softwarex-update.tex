...
threshold easy to fall below: the host is ${\approx}45\times$ faster at 36 spins and still ${\approx}1.5\times$
faster at 2048 spins and bond 16, and the device overtakes it only in the largest
...
128 (dense)    & 0.12 & 0.20 & 0.31 & 0.44 \\
128 (sparse)   & ---  & ---  & ---  & 0.84 \\
2048 (dense)   & 0.47 & 0.66 & 0.91 & --- \\
2048 (sparse)  & ---  & 0.76 & \textbf{1.42} & --- \\
\bottomrule
\end{tabular}
\end{table}
