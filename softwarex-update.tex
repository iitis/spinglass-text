...
${\approx}25\%$ faster --- median paired cold/warm ratios of $1.32$ and $1.34$
over five interleaved rounds, ${\approx}16\%$ over the whole ladder --- for
identical energies; the gain tracks how much of the solve is spent building
boundary MPS and shrinks where the search dominates.
...
in every cell. On the tested Xeon/H100 system, the CPU is preferable for exploratory
...
exact answer is available --- the regime the method exists for. It diagnoses the
contraction and does not by itself establish overall solver convergence or solution
quality. The consolidation and the deprecation shims make the
