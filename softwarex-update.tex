...
host-bound at every size measured; two changes to the host allocation pattern cut a
solve's allocated memory --- most sharply the contraction temporaries, down about
two-thirds (90.9 to 32~GiB on a 2048-spin bond-32 solve), a hardware-independent
reduction that reproduces on the H100. We also
