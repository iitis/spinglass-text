...
quoted in the SpinGlassPEPS.jl v2.0.1 software-update manuscript, whether it
appears in a figure, a table or the prose. The drivers run against the package itself
(<https://github.com/euro-hpc-pl/SpinGlassPEPS.jl>, ideally the tagged v2.0.1
...
## Recorded measurements from superseded code
...
Pin the package to the tagged `v2.0.1` release for a citable run.
